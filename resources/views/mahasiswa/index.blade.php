...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        @if ($mahasiswa && $mahasiswa->daftar_ujian && $pendaftaran && $ujian)
                    ...
                    <div class="flex flex-col gap-4 justify-between items-start mb-6 sm:flex-row">
                        ...
                        <div class="sm:text-right">
                            <span
                                ...
                                {{ strtoupper(__('mahasiswa_dashboard.status_verified')) }}
                            </span>
                    ...
                    <div class="flex flex-col gap-4 justify-between items-start mb-6 sm:flex-row">
                        ...
                        <div class="sm:text-right">
                            <span
                                ...
                                {{ strtoupper(__('mahasiswa_dashboard.status_pending')) }}
                            </span>
                            <p class="mt-1 text-xs text-gray-500 sm:mt-2 dark:text-gray-400">{{ __('mahasiswa_dashboard.registration_id') }}:
                                {{ $pendaftaran->no_pendaftaran }}</p>
                        </div>
            ...
            @endif
        @else
            @if ($mahasiswa && $mahasiswa->status === 'Alumni')
                <div class="p-6 w-full bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700"
                    data-aos="fade-left">
                    <div class="flex flex-col gap-4 justify-between items-start mb-6 sm:flex-row">
                        <div class="flex items-center">
                        ...
                        <div class="sm:text-right">
                            <span
                                ...
                                {{ strtoupper(__('mahasiswa_dashboard.status_alumni')) }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-4 justify-between items-start mb-6 sm:flex-row">
                        ...
                        <div class="sm:text-right">
                            <span
                                ...
                                {{ strtoupper(__('mahasiswa_dashboard.status_not_registered')) }}
                            </span>
                        </div>
                    </div>
                    ...
                    <a href="#"
                        ...
                        <div class="flex flex-col gap-2 justify-between items-start sm:flex-row sm:items-center">
                            ...
                            <div class="flex items-center">
                                ...
                                <span
                                    class="ml-1 text-gray-900 dark:text-white">{{ $item->created_at ? \Carbon\Carbon::parse($item->created_at)->translatedFormat('D, d M Y | H:i') : __('mahasiswa_dashboard.announcement_date_na') }} WIB</span>
                            </div>
                        </div>
                    </a>
                @endforeach
