                ...
                <div class="p-6 w-full bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700"
                    ...
                    <div class="grid grid-cols-1 gap-4 mb-6 md:grid-cols-2 sm:gap-6 sm:mb-8">
                        <div class="space-y-3 sm:space-y-4">
                            ...
                            <div>
                                <p class="text-xs font-medium text-gray-500 sm:text-sm dark:text-gray-400">NOMOR INDUK
                                    MAHASISWA
                                </p>
            ...
            @else
                <div class="p-6 w-full bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700"
                    ...
                    <div class="p-4 mb-6 bg-yellow-50 rounded-lg dark:bg-yellow-900/30">
                        <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pendaftaran Anda sedang
                            diproses</h3>
                        <p class="text-gray-700 dark:text-gray-300">
                            Data pendaftaran Anda sedang dalam proses verifikasi oleh admin. Harap menunggu konfirmasi lebih
                            lanjut melalui email atau halaman ini.
                        </p>
                    </div>

                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-xs text-center text-gray-500 dark:text-gray-400">
                            <span class="font-semibold">Catatan:</span> Proses verifikasi membutuhkan waktu 1-3 hari kerja.
                        </p>
                    </div>
                </div>
            @endif
                ...
                <div class="p-6 w-full bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700"
                    ...
                    <div class="flex flex-col gap-4 justify-between items-start mb-6 sm:flex-row">
                        <div class="flex items-center">
                            <img src="/img/PolinemaLogo.png" class="mr-3 h-10 sm:h-12 sm:mr-4" alt="Polinema Logo" />
                            <div>
                                <h2 class="text-xl font-bold text-gray-900 sm:text-2xl dark:text-white">Status Alumni</h2>
                                <p class="text-xs text-gray-500 sm:text-sm dark:text-gray-400">Politeknik Negeri Malang</p>
                            </div>
                        </div>
                        <div class="sm:text-right">
                    ...
                    <div class="p-4 mb-6 bg-purple-50 rounded-lg dark:bg-purple-900/30">
                        <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Pendaftaran Mandiri</h3>
                        <p class="text-gray-700 dark:text-gray-300">
                            Alumni hanya diperbolehkan mendaftar secara mandiri melalui prosedur khusus.
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-xs text-center text-gray-500 dark:text-gray-400">
                            <span class="font-semibold">Catatan:</span> Proses pendaftaran alumni membutuhkan verifikasi
                            tambahan.
                        </p>
                    </div>
                </div>
                ...
                <div class="p-6 w-full bg-white rounded-lg border border-gray-200 shadow-lg dark:bg-gray-800 dark:border-gray-700"
                    ...
                    <div class="flex flex-col gap-4 justify-between items-start mb-6 sm:flex-row">
                        <div class="flex items-center">
                            <img src="/img/PolinemaLogo.png" class="mr-3 h-10 sm:h-12 sm:mr-4" alt="Polinema Logo" />
                            <div>
                                <h2 class="text-xl font-bold text-gray-900 sm:text-2xl dark:text-white">Pendaftaran Ujian
                                </h2>
                                <p class="text-xs text-gray-500 sm:text-sm dark:text-gray-400">Politeknik Negeri Malang</p>
                            </div>
                        </div>
                    ...
                    <div class="mb-6 space-y-4 sm:mb-8">
                        <div class="p-4 bg-blue-50 rounded-lg dark:bg-blue-900/30">
                            <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Anda belum mendaftar ujian
                            </h3>
                            <p class="text-gray-700 dark:text-gray-300">
                        ...
                        <div class="p-4 bg-yellow-50 rounded-lg dark:bg-green-500/30">
                            <h3 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Persyaratan Pendaftaran
                            </h3>
