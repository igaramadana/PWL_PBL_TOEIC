...
<div class="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <div class="mt-4">
        <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">{{ __('pendaftaran.IndependentExam') }}
        </h2>
...
<div class="p-6 text-center bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">{{ __('pendaftaran.title') }} {{
        __('pendaftaran.NoExamsAvailable') }}</h3>
    <p class="mt-1 text-gray-500 dark:text-gray-400">{{ __('pendaftaran.NoExamsAvailableMessage') }}</p>
</div>
@else
<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
    @foreach ($pendaftaran as $item)
    <div class="relative bg-white rounded-lg shadow-md transition-shadow duration-300 dark:bg-gray-800 hover:shadow-lg">
        <!-- Status Badge -->
        ...
        <div class="p-6">
            <div class="flex items-start mb-4">
                <div class="flex-shrink-0 mr-4">
                    <div class="flex justify-center items-center w-12 h-12 bg-blue-100 rounded-full dark:bg-blue-900">
            ...
            <div class="mt-6">
                ...
                <div
                    ...
                    <span class="text-base font-semibold text-red-700 dark:text-red-200">{{ __('pendaftaran.ExamClosed')
                        }}</span>
                </div>
                @endif
            </div>
