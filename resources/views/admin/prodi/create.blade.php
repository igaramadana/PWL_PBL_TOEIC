<div id="crud-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form id="prodi-form" class="p-4 md:p-5" action="{{ route('prodi.store') }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4">
                    <div>
                        <label for="prodi_kode"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('prodi.modalFormCode') }}</label>
                        <input type="text" name="prodi_kode" id="prodi_kode"
                    ...
                    <div>
                        ...
                        <p id="jurusan-error" class="hidden mt-1 text-xs text-red-600 dark:text-red-400">
                            <span id="jurusan-error-message"></span>
                        </p>
                    </div>
                </div>
                <button type="submit"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const elements = {
            kodeInput: document.getElementById('prodi_kode'),
            namaInput: document.getElementById('prodi_nama'),
            jurusanInput: document.getElementById('jurusan_id'),
            ...
            jurusanErrorMessage: document.getElementById('jurusan-error-message')
        };
        ...
        form.addEventListener('submit', function(e) {
            ...
            clearError(elements.jurusanError, elements.jurusanErrorMessage);
            ...
            if (!elements.jurusanInput.value.trim()) {
                showError(elements.jurusanError, elements.jurusanErrorMessage, errorMessages
                    .jurusanRequired);
                isValid = false;
            }
        ...
        if (elements.jurusanInput) {
            elements.jurusanInput.addEventListener('change', function() {
                clearError(elements.jurusanError, elements.jurusanErrorMessage);
            });
        }
    });
