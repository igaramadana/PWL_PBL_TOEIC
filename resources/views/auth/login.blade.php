        ...
        <section class="bg-gray-50 dark:bg-gray-900">
            <div class="flex flex-col justify-center items-center px-6 py-6 mx-auto md:h-screen lg:py-0">
                <a href="#" class="flex items-center mb-6 text-xl font-semibold text-gray-900 dark:text-white">
                    <img src="/img/SistemLogo.png" alt="logo" style="width: 55px; height: auto;">
                    TOEIC
                </a>
                <div class="w-full bg-white rounded-lg border border-gray-200 shadow-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700"
                    data-aos="zoom-in-down">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1
                            class="text-xl font-bold tracking-tight leading-tight text-gray-900 md:text-2xl dark:text-white">
                            {{ __('login.loginTitle') }}
                        </h1>
                                ...
                                <ul class="space-y-1">
                                    @foreach ($errors->all() as $error)
                                        <li class="flex items-start">
                                            <svg class="flex-shrink-0 mt-0.5 mr-1 w-4 h-4" fill="currentColor"
                        ...
                        <form id="login-form" class="space-y-4 md:space-y-6" action="{{ route('login.process') }}"
                            ...
                            <div
                                class="flex flex-col justify-between items-start space-y-3 sm:flex-row sm:items-center sm:space-y-0">
