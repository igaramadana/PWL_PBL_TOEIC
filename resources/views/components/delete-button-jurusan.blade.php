<div>
    <button data-modal-target="popup-modal-{{ $jurusan_id }}" data-modal-toggle="popup-modal-{{ $jurusan_id }}"
        type="button"
    ...
    <form action="{{ route('jurusan.delete', $jurusan_id) }}" method="POST">
        @csrf
        @method('DELETE')

        <div id="popup-modal-{{ $jurusan_id }}" tabindex="-1"
            ...
            <div class="relative p-4 w-full max-w-lg max-h-xl">
                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    <button type="button"
                        ...
                        data-modal-hide="popup-modal-{{ $jurusan_id }}">
                    ...
                    <div class="p-4 text-center md:p-5">
                        ...
                        <button data-modal-hide="popup-modal-{{ $jurusan_id }}" type="submit"
                        ...
                        <button data-modal-hide="popup-modal-{{ $jurusan_id }}" type="button"
