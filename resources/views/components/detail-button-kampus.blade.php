            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="detail-modal-{{ $kampus_id }}">
                ...
                <div class="p-4 md:p-5">
                    ...
                    <button type="button" data-modal-toggle="detail-modal-{{ $kampus_id }}"
