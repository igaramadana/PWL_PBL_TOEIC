<div>
    <button data-modal-target="detail-modal-{{ $prodi_id }}" data-modal-toggle="detail-modal-{{ $prodi_id }}"
        type="button"
    ...
    <!-- Modal Detail -->
    <div id="detail-modal-{{ $prodi_id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="detail-modal-{{ $prodi_id }}">
                    ...
                    <div class="grid gap-4 mb-5">
                        <div class="p-2 bg-white rounded-md border border-gray-600 dark:bg-gray-600">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white">
                                {{ __('prodi.modalFormId') }}</h4>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $prodi_id ?? '-' }}</p>
                        </div>
                        <div class="p-2 bg-white rounded-md border border-gray-600 dark:bg-gray-600">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white">
                                {{ __('prodi.modalFormCode') }}</h4>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $prodi_kode ?? '-' }}</p>
                        </div>
                        <div class="p-2 bg-white rounded-md border border-gray-600 dark:bg-gray-600">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white">
                                {{ __('prodi.modalFormName') }}</h4>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $prodi_nama ?? '-' }}</p>
                        </div>
                        <div class="p-2 bg-white rounded-md border border-gray-600 dark:bg-gray-600">
                            <h4 class="text-sm font-medium text-gray-900 dark:text-white">
                                {{ __('prodi.modalFormJurusan') }}</h4>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $jurusan_nama ?? '-' }}</p>
                        </div>
                    </div>
                    <button type="button" data-modal-toggle="detail-modal-{{ $prodi_id }}"
